...
(add-to-list 'default-frame-alist '(font . "Roboto Mono-12:medium"))
;; }}}
...
(custom-set-faces
 ...
 '(neo-dir-link-face ((t (:foreground "#999"))))
 '(neo-file-link-face ((t (:foreground "#bbb"))))
 '(neo-root-dir-face ((t (:foreground "#fff"))))
